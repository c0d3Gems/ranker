...
<svelte:head>
	<title>Politici de Confidențialitate - Analistul.com</title>
	<meta
		name="description"
		content="Politica de Confidențialitate ale aplicatiei web Analistul.com."
	/>
...
<main>
	<div class="content">
		<h1>Cookie Policy for Analistul</h1>

		<p>This is the Cookie Policy for Analistul, accessible from https://analistul.com</p>
		...
		<ul>
			...
			<li>
				<p>
					...
					sites including; Facebook, Instagram, YouTube, Whatsapp, will set cookies through our site
					which may be used to enhance your profile on their site or contribute to the data they
		...
		<ul>
			<li>By visiting this link: https://analistul.com/confidentialitate</li>
		</ul>
	</div>
</main>
<Footer />
